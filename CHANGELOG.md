...
## [0.1.32](https://github.com/rymalia/gnhf/compare/gnhf-v0.1.49...gnhf-v0.1.32) (2026-09-04)


### Features

* add live terminal title updates ([#70](https://github.com/rymalia/gnhf/issues/70)) ([f8b57d6](https://github.com/rymalia/gnhf/commit/f8b57d6a7640cff457f3d399b4aa1b44bb37abbe))
* add RovoDev agent support ([#11](https://github.com/rymalia/gnhf/issues/11)) ([484d989](https://github.com/rymalia/gnhf/commit/484d989a632aebef27b4592f96ffd7fd4f25fde0))
* Add support for Pi coding agent ([#97](https://github.com/rymalia/gnhf/issues/97)) ([380de4e](https://github.com/rymalia/gnhf/commit/380de4e97ea4d08517cf8fa0352b3db035c6517b))
* **agents:** add ACP agent support ([#112](https://github.com/rymalia/gnhf/issues/112)) ([5157712](https://github.com/rymalia/gnhf/commit/51577120c8005c966f4de0ae70f2d67e9b60784f))
* **agents:** add native Cursor CLI support ([#203](https://github.com/rymalia/gnhf/issues/203)) ([06ae1cf](https://github.com/rymalia/gnhf/commit/06ae1cf025704fe3ca669983b0a68b8dbb99c23b))
* **agents:** support ACP registry overrides ([#117](https://github.com/rymalia/gnhf/issues/117)) ([8d47386](https://github.com/rymalia/gnhf/commit/8d473861d9596dadc5f943923f1b1da810d97690))
* **agents:** use prompt_async endpoint instead of blocking /message ([#56](https://github.com/rymalia/gnhf/issues/56)) ([ef5d6d3](https://github.com/rymalia/gnhf/commit/ef5d6d3c8c6634abccaebd28db59086cb294f8ee))
* **cli:** add configurable meteor frequency ([#135](https://github.com/rymalia/gnhf/issues/135)) ([785435d](https://github.com/rymalia/gnhf/commit/785435d8f9cfa02cdd547dc852ee635bc6f473f9))
* **cli:** add iteration and token caps ([#9](https://github.com/rymalia/gnhf/issues/9)) ([b92e9ac](https://github.com/rymalia/gnhf/commit/b92e9aca196647b19c854b722551e401c4ce72a7))
* **cli:** print post-run exit summaries ([#126](https://github.com/rymalia/gnhf/issues/126)) ([f3622f5](https://github.com/rymalia/gnhf/commit/f3622f5ab302a8c0db04b4302fdca69bb6b6912b))
* **cli:** support per-agent model selection ([#225](https://github.com/rymalia/gnhf/issues/225)) ([33d89fb](https://github.com/rymalia/gnhf/commit/33d89fb54795c8d88512e833d50c7e18f01c1eda))
* **cli:** support pushing current-branch runs ([#132](https://github.com/rymalia/gnhf/issues/132)) ([306bdec](https://github.com/rymalia/gnhf/commit/306bdec6f54b011a552985ea4a57be6bf7c2e7ac))
* **codex:** allow per-agent cli arg overrides ([#58](https://github.com/rymalia/gnhf/issues/58)) ([4c1731e](https://github.com/rymalia/gnhf/commit/4c1731e0f1fc321d3ac63818bffe6dd245ed3dbe))
* **config:** add agent path overrides ([#24](https://github.com/rymalia/gnhf/issues/24)) ([c8a71c6](https://github.com/rymalia/gnhf/commit/c8a71c61019fd4795dabe3e5bdda4e7a44771855))
* **core:** add anonymous run telemetry ([#114](https://github.com/rymalia/gnhf/issues/114)) ([a2dca97](https://github.com/rymalia/gnhf/commit/a2dca9744650c019ba90faa590440f8909057ccc))
* **core:** add detailed error logging ([#54](https://github.com/rymalia/gnhf/issues/54)) ([84eaa15](https://github.com/rymalia/gnhf/commit/84eaa15e740d35e81508a4dce91405656eb34ff3))
* **core:** support raw ACP command specs ([#122](https://github.com/rymalia/gnhf/issues/122)) ([ef7bfb2](https://github.com/rymalia/gnhf/commit/ef7bfb2ee698d04083d5004266f52e57cafa94ac))
* **core:** track branch commits from run base ([#5](https://github.com/rymalia/gnhf/issues/5)) ([dce09e6](https://github.com/rymalia/gnhf/commit/dce09e6a0a47644a174428c7a29b6e19f189486b))
* **core:** wait for Claude usage-limit reset instead of aborting on rate limits ([#179](https://github.com/rymalia/gnhf/issues/179)) ([2e1dd13](https://github.com/rymalia/gnhf/commit/2e1dd137e968f3ec81e85ff6b45db8033667e0eb))
* git worktree support so that it can support multiple features to one git repository ([#63](https://github.com/rymalia/gnhf/issues/63)) ([bf9e3d8](https://github.com/rymalia/gnhf/commit/bf9e3d86899e6f3c6421605566849d110b55c1db))
* graceful shutdown on first ctrl+c ([#88](https://github.com/rymalia/gnhf/issues/88)) ([385211d](https://github.com/rymalia/gnhf/commit/385211d7e460d8a3abd273f40b69b01eb368b690))
* initial commit ([c8ae6d2](https://github.com/rymalia/gnhf/commit/c8ae6d21f4cf0b493386c00bdaa023b947d02451))
* **opencode:** add OpenCode agent integration ([#13](https://github.com/rymalia/gnhf/issues/13)) ([aa9a2a5](https://github.com/rymalia/gnhf/commit/aa9a2a5cecbfe95abe6830dff40750aa03ee0423))
* **orchestrator:** add --stop-when condition to end loop ([#74](https://github.com/rymalia/gnhf/issues/74)) ([3ad2c86](https://github.com/rymalia/gnhf/commit/3ad2c861afcc47d46037e076e9646b29a167448d))
* **renderer:** adapt content to viewport ([#20](https://github.com/rymalia/gnhf/issues/20)) ([592d80b](https://github.com/rymalia/gnhf/commit/592d80b6d9befb9a38f44cc19346e736c01a5220))
* **renderer:** randomize star field seeds ([#22](https://github.com/rymalia/gnhf/issues/22)) ([e658f32](https://github.com/rymalia/gnhf/commit/e658f32004bc54b66ef3c23fec85857f1132fece))
* **renderer:** render meteors beside content ([#139](https://github.com/rymalia/gnhf/issues/139)) ([6538a2a](https://github.com/rymalia/gnhf/commit/6538a2af397876f1531e593ef4c067626f6181e8))
* **sleep:** prevent system sleep during runs ([#17](https://github.com/rymalia/gnhf/issues/17)) ([091d9d3](https://github.com/rymalia/gnhf/commit/091d9d31b80a4c1b3c01fd7e65009ad86d864ec1))
* **worktree:** resume into a preserved worktree on re-invocation ([#76](https://github.com/rymalia/gnhf/issues/76)) ([f0e05f3](https://github.com/rymalia/gnhf/commit/f0e05f3a819b396367415942715b755a2ac62b33))


### Bug Fixes

* **agents:** count ACP thought text as output tokens ([#118](https://github.com/rymalia/gnhf/issues/118)) ([f8881e4](https://github.com/rymalia/gnhf/commit/f8881e4b8e8c39257023619396ebd73185ef287e))
* **agents:** dedupe Claude usage across repeated assistant snapshots ([#72](https://github.com/rymalia/gnhf/issues/72)) ([22a4728](https://github.com/rymalia/gnhf/commit/22a472831471b66051c27018ac8a033e3c06299d))
* **agents:** extend Rovo Dev startup timeout ([#104](https://github.com/rymalia/gnhf/issues/104)) ([0b2bbe5](https://github.com/rymalia/gnhf/commit/0b2bbe52f9398fa8028b514252918243b4f7f8f5))
* **agents:** filter unrelated OpenCode session errors ([#142](https://github.com/rymalia/gnhf/issues/142)) ([2093a4a](https://github.com/rymalia/gnhf/commit/2093a4a686b048d9a044840bc36b91154dda83f1))
* **agents:** make stop output schema conditional on --stop-when ([#82](https://github.com/rymalia/gnhf/issues/82)) ([36f69e8](https://github.com/rymalia/gnhf/commit/36f69e8d480f259b0142eb5aa9e1b25ad69f09cc))
* **agents:** mark ACP token estimates consistently ([#119](https://github.com/rymalia/gnhf/issues/119)) ([80fc97d](https://github.com/rymalia/gnhf/commit/80fc97d12e2535281c1fa0baa2c1f7a7b7f6ca04))
* **agents:** preserve final Claude output before forced shutdown ([#93](https://github.com/rymalia/gnhf/issues/93)) ([61e37a8](https://github.com/rymalia/gnhf/commit/61e37a87ea3811e16f1e04ba7dd38db8ce94a011))
* **agents:** recover copilot and opencode JSON output ([#149](https://github.com/rymalia/gnhf/issues/149)) ([55d2c39](https://github.com/rymalia/gnhf/commit/55d2c399f35b7c3da80d5328e988121d630fbc07))
* **agents:** recover schema-valid agent JSON output ([#145](https://github.com/rymalia/gnhf/issues/145)) ([b5ffc2d](https://github.com/rymalia/gnhf/commit/b5ffc2dde57b27199c43aae29849a7c07416fbe6))
* **agents:** recover wrapped Pi JSON output ([#195](https://github.com/rymalia/gnhf/issues/195)) ([f47d916](https://github.com/rymalia/gnhf/commit/f47d916fd3d98d6784305fca3931c77c6e068121))
* **agents:** surface Claude CLI exit errors ([#190](https://github.com/rymalia/gnhf/issues/190)) ([3041614](https://github.com/rymalia/gnhf/commit/3041614ba7f45fc758eb156716a1343942b4a052))
* **agents:** surface shared CLI stdout errors ([#202](https://github.com/rymalia/gnhf/issues/202)) ([5cc31af](https://github.com/rymalia/gnhf/commit/5cc31afd89668ec653d60fd11418625db4d7c5b4))
* **claude:** surface limit failure state ([#223](https://github.com/rymalia/gnhf/issues/223)) ([693f1d5](https://github.com/rymalia/gnhf/commit/693f1d564a31fa419c0c0989aad8fb89a48578df))
* **cli:** clarify loop prompts and abort UI ([#26](https://github.com/rymalia/gnhf/issues/26)) ([90022c1](https://github.com/rymalia/gnhf/commit/90022c1df1d0456d67255c6d36dec968ffa9e943))
* **cli:** correct version flag ([a1203ca](https://github.com/rymalia/gnhf/commit/a1203caf8a6fbb794b8a954b4acdf79ebba2ebd8))
* **cli:** handle generated branch and worktree slug collisions ([#106](https://github.com/rymalia/gnhf/issues/106)) ([df81f78](https://github.com/rymalia/gnhf/commit/df81f7804e6ed12c7c34e4a920938bd1f83702bf))
* **cli:** handle resume prompt overwrite from the controlling terminal ([#77](https://github.com/rymalia/gnhf/issues/77)) ([cc18215](https://github.com/rymalia/gnhf/commit/cc1821531af107adfd31253feabdd24077867110))
* **cli:** keep worktrees across Linux sleep re-exec ([1c2344f](https://github.com/rymalia/gnhf/commit/1c2344f0cffb4f34fe5d903ed208abd2a64b3f88))
* **cli:** persist stop-when on resume ([#100](https://github.com/rymalia/gnhf/issues/100)) ([0051228](https://github.com/rymalia/gnhf/commit/00512284b8bd7d71e421a0bd408d7ed7bb418172))
* **cli:** preserve committed worktrees on forced shutdown ([#189](https://github.com/rymalia/gnhf/issues/189)) ([c12cdbf](https://github.com/rymalia/gnhf/commit/c12cdbf5834d1b285954f8760ad2400977a57a78))
* **cli:** preserve run history when updating a resumed prompt ([#91](https://github.com/rymalia/gnhf/issues/91)) ([61306e9](https://github.com/rymalia/gnhf/commit/61306e9a2a29f8ebd6885f1fe02bdf1fd3b8917b))
* **cli:** resume same-prompt current-branch runs ([#137](https://github.com/rymalia/gnhf/issues/137)) ([0b6eccf](https://github.com/rymalia/gnhf/commit/0b6eccfa076868cc3477de2c79f36bbb4f1b0c56))
* **cli:** show friendly non-git error ([#7](https://github.com/rymalia/gnhf/issues/7)) ([65acf6b](https://github.com/rymalia/gnhf/commit/65acf6be343b805b99a6011d1562ac54b05b6760))
* **core:** abort immediately on Claude low credit ([#102](https://github.com/rymalia/gnhf/issues/102)) ([28f54bb](https://github.com/rymalia/gnhf/commit/28f54bb939a098e463c40cefb0683da897b999e6))
* **core:** clarify no-mistakes review link ([#129](https://github.com/rymalia/gnhf/issues/129)) ([6ecd669](https://github.com/rymalia/gnhf/commit/6ecd6692bcd4f0f84f53244d16ecfac41c89c0da))
* **core:** count cache tokens toward the --max-tokens budget ([#213](https://github.com/rymalia/gnhf/issues/213)) ([73b9ed7](https://github.com/rymalia/gnhf/commit/73b9ed7039a0ee214c4d3549af6ae8b249d07e4b))
* **core:** drop issue marker from default commits ([#124](https://github.com/rymalia/gnhf/issues/124)) ([2f99dfb](https://github.com/rymalia/gnhf/commit/2f99dfbd300b46175e41edae0fd35b134e45f102))
* **core:** harden git command inputs against shell injection ([#68](https://github.com/rymalia/gnhf/issues/68)) ([b19d778](https://github.com/rymalia/gnhf/commit/b19d778a1322d636e1179aa29b5fe606e7c8b0cc))
* **core:** honor pending token abort before success ([#217](https://github.com/rymalia/gnhf/issues/217)) ([bf2edd9](https://github.com/rymalia/gnhf/commit/bf2edd9aaf89d5cf8085f176edeb9032d0ad3dd6))
* **core:** keep exit summary within terminal width ([#128](https://github.com/rymalia/gnhf/issues/128)) ([0e65519](https://github.com/rymalia/gnhf/commit/0e65519f602abbbde21b817f95d5fb742a2df0df))
* **core:** make Windows sleep prevention hold the machine awake ([#209](https://github.com/rymalia/gnhf/issues/209)) ([b50209a](https://github.com/rymalia/gnhf/commit/b50209ae25374034c164ebde66859a32398c1048))
* **core:** preserve agent output and back off only on hard errors ([#89](https://github.com/rymalia/gnhf/issues/89)) ([b369ae8](https://github.com/rymalia/gnhf/commit/b369ae80fd752d11729046d971a5ab09be18c394))
* **core:** preserve commit-failure workspaces for repair ([#134](https://github.com/rymalia/gnhf/issues/134)) ([bfb90cc](https://github.com/rymalia/gnhf/commit/bfb90ccbd9a46aad3dcd39def5d2ffc3e78c65e9))
* **core:** retry failed commits without hooks ([#130](https://github.com/rymalia/gnhf/issues/130)) ([bb2c2f9](https://github.com/rymalia/gnhf/commit/bb2c2f9737fa5d43abaea9e3c2de0b62ea068469))
* **core:** wait for the usage window instead of billing extra usage ([#221](https://github.com/rymalia/gnhf/issues/221)) ([1689ace](https://github.com/rymalia/gnhf/commit/1689ace19d91db7636a6eef1a8b385495858826d))
* execute every PR body compliance event ([#180](https://github.com/rymalia/gnhf/issues/180)) ([1d06739](https://github.com/rymalia/gnhf/commit/1d0673920f3ee6427bc75805faccd02a6d614e84))
* **iteration-prompt:** clarify notes.md instructions ([2182240](https://github.com/rymalia/gnhf/commit/218224073890831d667850272b4234f6fefc68b8))
* Normalize changes and learnings to avoid JSON schema non-adherence to break the notes.md file ([#59](https://github.com/rymalia/gnhf/issues/59)) ([3b1427b](https://github.com/rymalia/gnhf/commit/3b1427b8eeaac7463da95c358e4bf8a510542772))
* **opencode:** time out individual server health check requests ([#177](https://github.com/rymalia/gnhf/issues/177)) ([6bfdcca](https://github.com/rymalia/gnhf/commit/6bfdcca98cfc227dec0cbe2a51b007e4252287f2))
* **orchestrator:** handle aborts and preserve successful recordings ([#66](https://github.com/rymalia/gnhf/issues/66)) ([7ad041d](https://github.com/rymalia/gnhf/commit/7ad041ddabdd70cf18e1a20e2ed917e7372bc2da))
* **renderer:** clear terminal title on exit ([#115](https://github.com/rymalia/gnhf/issues/115)) ([9ed3172](https://github.com/rymalia/gnhf/commit/9ed3172b5b7c3a4d517e9a1d4a4cc5fb10a9ecce))
* repo field in package json ([d635f42](https://github.com/rymalia/gnhf/commit/d635f42286f2a2904752d3d06319e2950d992934))
* **schema:** enforce strict output schema ([#14](https://github.com/rymalia/gnhf/issues/14)) ([085aef7](https://github.com/rymalia/gnhf/commit/085aef74ba647a582aa280697213790abfa49cfa))
* update README and lower maxConsecutiveFailures to 3 ([ad8925b](https://github.com/rymalia/gnhf/commit/ad8925b93e80e62af615eff7fc56e8399cdee4b8))


### Miscellaneous Chores

* rebuild release with telemetry website id baked in ([b6a9920](https://github.com/rymalia/gnhf/commit/b6a9920edf008b1d7704f8aee3cbfc84c25793d8))
